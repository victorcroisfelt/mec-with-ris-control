...
f = 2e9;                % Frequency
overall_channel_user_RIS = zeros(N_RIS, K, N_slot); overall_channel_RIS_AP = zeros(Nr, N_RIS, K, N_slot); overall_channel_AP = zeros(Nr, K, N_slot);
for qq = 1:K
...
function [current_v, opt_beam] = Greedy_RIS(current_v, N_blocks, N_RIS, possible_v, K, channel_RIS, channel_RIS_AP,...
    channel_AP, N0, B_u, V, Q_tilde_up, p_bit, alpha, possible_angles, weights_comb, Nr)
